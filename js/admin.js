...
<p class="list-quantity" style="margin-top: 5px; font-size: 14px;">Tồn kho: <strong>${product.quantity}</strong></p>
                       </div>
                   </div>
...
function editProduct(id) {
    ...
    document.getElementById("so-luong").value = products[index].quantity;
